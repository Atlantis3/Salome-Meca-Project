...
df1 = pd.read_csv('/home/akram_metar/D_Drive/Salome_meca/Disk_geometry/disk_top_nodes_7.txt',skiprows=4,sep='\s+').groupby('NUME_ORDRE')
...
ax1.plot(displacement,df1_load,label='Disk Problem',marker='o')
