...
geompy.addToStudy(vertices[0],'vertice_1')
geompy.addToStudy(vertices[1],'vertice_2')
geompy.addToStudy(vertices[2],'vertice_3')
geompy.addToStudy(vertices[3],'vertice_4')
